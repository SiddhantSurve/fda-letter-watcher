...
-- Qualify pgmq references now that search_path is empty
...
-- Revoke public API access to SECURITY DEFINER functions; keep service_role only
...
REVOKE ALL ON FUNCTION public.set_warning_letters_posted_on() FROM PUBLIC, anon, authenticated;
